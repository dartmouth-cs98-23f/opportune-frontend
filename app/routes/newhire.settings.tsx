...
export async function action({
    ...
    if(_action === 'changeEmail') {
        try {
            ...
            console.log(error);
            return redirect('/newhire/settings?failed=1');
        }
        ...
        try {
            ...
            console.log(error);
            return redirect('/newhire/settings?failed=2');
          }
    } else {
        return null;
    }
...
export default function CompanySettings() {
    ...
    return (
        <div className="company-container">
            ...
            <Form method="post" action="/newhire/settings" className="info-form form-left">
              ...
              <TextField
                  label="Email"
                  classLabel="email"
                  value={info?.data.new_hire.email}
                  type="email"
              />
