...
export async function action({
    ...
    if(_action === 'changeEmail') {
        try {
            ...
            console.log(error);
            return redirect('/team/settings?failed=1');
        }
        ...
        try {
            ...
            console.log(error);
            return redirect('/team/settings?failed=2');
          }
    } else {
        return null;
    }
...
export default function CompanySettings() {
    ...
    return (
        <div className="company-container">
            ...
            <Form method="post" action="/team/settings" className="info-form form-left">
